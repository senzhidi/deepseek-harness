...
import codexCredentialImportRemote from '@deepseek-ai/dsh-host-codex-credential-import/remote'
...
} from '@deepseek-ai/dsh-host-codex-credential-import/types'
export type { PluginInventorySnapshot } from '@deepseek-ai/dsh-host-plugin-inventory/types'
export type {} from '@deepseek-ai/dsh-commands/remote'
export type {} from '@deepseek-ai/dsh-file-reference/remote'
export type {} from '@deepseek-ai/dsh-goal/remote'
export type {} from '@deepseek-ai/dsh-host-codex-credential-import/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      codexCredentialImportRemote, pluginInventoryRemote, messageFeedbackRemote, sessionReferencesRemote,
    ]) {
