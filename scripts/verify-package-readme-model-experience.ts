...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-codex-credential-import': { kind: 'none', reason: 'Browser-side credential settings surface; registers nothing model-facing.' },
  ...
  'packages/host/codex-credential-import': { kind: 'none', reason: 'Host-side credential mutation boundary; registers nothing model-facing.' },
